...
/**
 * Catalogue espagnol, pas encore traduit.
 *
 * Il est volontairement vide plutôt qu'ébauché. Une poignée de clés traduites au milieu de
 * trois cents ne donne pas une page espagnole : elle donne une page française parsemée de
 * mots espagnols, ce qui se lit plus mal que la page française entière. Tant que la
