...
export const fr = {
  ...
  'subscription.payMonthly': 'Au mois',
  'subscription.payYearly': 'À l’année',
  'subscription.yearlyOff': '−{percent} %',
  'subscription.yearlyEquivalent': 'soit {amount} par mois, {percent} % d’économie',
  'subscription.monthlyOnly': 'Cette offre se prend au mois uniquement.',
  ...
  'subscription.groupMeasure': 'Vos chiffres de recherche',
  ...
  'subscription.creditsHint':
    'Les crédits paient les appels à l’IA : explications, corrections rédigées, questions à l’équipe. Les audits et les deux notes n’en consomment aucun — ils sont calculés, pas devinés. Le prix est annoncé avant chaque action.',
  ...
  'vis.plansYearly': 'ou {amount} par an — {percent} % d’économie',
  ...
  'vis.plansAuditsOne': '{count} audit par mois',
  ...
  'vis.plansShop': 'Lecture de votre boutique Shopify',
  ...
  'vis.compareShop': 'Boutique Shopify',
