...
export const en: Record<keyof typeof fr, string> = {
  ...
  'subscription.noBuild': 'Stops before building: ideas, analyses and specification, without going live',
  ...
  'subscription.creditsHint':
    'Credits pay for AI calls: ideas, analyses, building, questions to the team. The price is shown before each action.',
