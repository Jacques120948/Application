...
export const en: Record<keyof typeof fr, string> = {
  ...
  'subscription.payMonthly': 'Monthly',
  'subscription.payYearly': 'Yearly',
  'subscription.yearlyOff': '−{percent}%',
  'subscription.yearlyEquivalent': 'that is {amount} per month, {percent}% off',
  'subscription.monthlyOnly': 'This plan is monthly only.',
  ...
  'subscription.groupMeasure': 'Your search figures',
  ...
  'vis.plansYearly': 'or {amount} per year — save {percent}%',
  ...
  'vis.plansShop': 'Read your Shopify store',
