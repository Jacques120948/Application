    ...
    pages: [
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              { title: 'Tout au même endroit', body: 'Retrouvez vos éléments depuis n\'importe quel appareil.' },
              { title: 'Simple à utiliser', body: 'Une interface claire, sans réglage compliqué.' },
              { title: 'Vos données vous appartiennent', body: 'Chaque compte ne voit que ses propres données.' },
            ],
          },
    ...
    pages: [
      {
        ...
        blocks: [
          ...
          { id: 'presentation', type: 'richText', title: 'Présentation', body: description },
          {
            ...
            items: [
              { title: 'Choisissez un créneau', body: 'Indiquez la date qui vous convient.' },
              { title: 'Recevez une confirmation', body: 'Votre demande est enregistrée immédiatement.' },
              { title: 'Suivez vos rendez-vous', body: 'Retrouvez vos réservations dans votre espace.' },
            ],
          },
        ],
      },
    ...
    pages: [
      {
        ...
        blocks: [
          { id: 'hero', type: 'hero', title: name, subtitle: tagline, ctaLabel: 'Commencer', ctaPageId: 'suivi' },
          {
            ...
            title: 'La méthode',
            items: [
              { title: 'Fixez un objectif', body: 'Un objectif clair, atteignable, à votre rythme.' },
