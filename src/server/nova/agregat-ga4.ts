...
function nouveauJour(jour: string): JourVisites {
  return { jour, sessions: 0, sessionsEngagees: 0, achats: 0, revenuCents: 0, canaux: {}, appareils: {}, pages: [], pagesSeo: [] }
}
...
export function agregerVisites(canaux: LigneRapport[], pages: LigneRapport[], pagesSeo: LigneRapport[]): JourVisites[] {
