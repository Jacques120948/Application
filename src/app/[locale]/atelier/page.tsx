...
/**
 * L'atelier : l'ancien tableau de bord du constructeur d'applications.
 *
 * Evoliia ne vend plus la construction d'applications, et cet écran a donc quitté la barre
 * de navigation. Il n'est pas supprimé pour autant : des projets existent, ils tournent, et
 * les rendre inaccessibles aurait été une perte sèche pour ceux qui les ont construits. On
 * y accède par son adresse, et par elle seule.
 *
